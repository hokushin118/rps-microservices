...
class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests()
                ...
                .antMatchers(HttpMethod.GET, String.format("/%s/%s/**", this.adminUrl, this.gamesUrl)).hasAuthority("ROLE_ADMIN")
                .antMatchers(HttpMethod.GET, String.format("/%s/**", this.gamesUrl)).hasAnyAuthority("ROLE_ADMIN", "ROLE_USER")
