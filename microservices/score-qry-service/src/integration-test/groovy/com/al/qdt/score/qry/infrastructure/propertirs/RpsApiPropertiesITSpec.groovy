...
class RpsApiPropertiesITSpec extends AbstractIntegrationTests {
    ...
    static final DEV_SERVER_BASE_URL = 'http://localhost:0/score-qry-api'
    ...
    def 'Testing injected properties'() {
        expect:
        HOSTNAME == rpsApiProperties.hostname
