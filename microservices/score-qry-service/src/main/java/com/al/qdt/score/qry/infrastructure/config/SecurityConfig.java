...
class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests()
                ...
                .antMatchers(HttpMethod.GET, String.format("/%s/%s/**", this.adminUrl, this.scoresUrl)).hasAuthority("ROLE_ADMIN")
                .antMatchers(HttpMethod.GET, String.format("/%s/**", this.scoresUrl)).hasAnyAuthority("ROLE_ADMIN", "ROLE_USER")
