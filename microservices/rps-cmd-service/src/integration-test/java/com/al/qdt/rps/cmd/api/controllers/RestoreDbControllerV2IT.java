...
@WebMvcTest(RestoreDbControllerV2.class)
@Import(ProtoConfig.class)
@DisplayName("Integration testing of the RestoreDbControllerV2 controller with partial context loading")
@Tag(value = "controller")
class RestoreDbControllerV2IT extends AbstractWebIntegrationTests implements ProtoTests {
