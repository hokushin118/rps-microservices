...
class EventDeserializerIT extends AbstractTest {
    ...
    <T extends BaseEvent> void eventDeserializationTest(String key, T event, Class<T> clazz) throws InterruptedException {
     ...
     */
    private <T extends BaseEvent> void deserialize(String key, T event, Class<T> clazz) throws InterruptedException {
