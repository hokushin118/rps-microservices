package com.al.qdt.common.infrastructure.events;
...
import static com.al.qdt.common.infrastructure.helpers.Constants.EXECUTION_EXCEPTION_MESSAGE;
...
class EventSerializerIT extends AbstractTest {
    ...
    <T extends BaseEvent> void eventSerializationTest(String key, T event, Class<T> clazz) throws JsonProcessingException, InterruptedException {
     ...
     */
    private <T extends BaseEvent> void serialize(String key, T event, Class<T> clazz) throws InterruptedException, JsonProcessingException {
