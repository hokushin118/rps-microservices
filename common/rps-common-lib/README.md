# RPS Game Microservices Common Library Project
The RPS Game Microservices Common library project contains Rock Paper Scissors game microservices common logic and configuration.
### Prerequisites
* Java 11 or higher
### Technology stack
...
### Building the RPS Game Microservices Common Library Project from the command line
